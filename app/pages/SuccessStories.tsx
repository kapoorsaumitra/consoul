  ...
  return (
    <div>
      <div className="p-4 md:p-10 flex flex-col items-center  relative overflow-hidden">
        <div className="font-extrabold text-[#555555] text-2xl md:text-4xl my-4 md:my-6">Proven Success Stories</div>
        <div className="text-2xl md:text-4xl font-extrabold text-[#555555]">
          ...
          <span className="text-[#6438C3]">communication </span> can do. Story of {stories[index].title}:
        </div>
        ...
        <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center justify-between space-y-6 lg:space-y-0 mt-4 md:mt-8">
            ...
            >
              <ul className="space-y-2 md:space-y-3 mt-4">
                {stories[index].metrics.map((metric, idx) => (
                  <li key={idx} className="flex items-center text-base md:text-lg text-[#555555] font-medium">
          ...
          <div className="lg:w-1/2 flex justify-center">
            ...
            >
              <img src={stories[index].image || "/placeholder.svg"} alt="Success Story" className="max-w-full h-auto" />
            </motion.div>
          </div>
        </div>
        ...
        <div className="absolute bottom-4 md:bottom-0 flex space-x-4 md:space-x-6">
          <button onClick={prevStory} className="flex-shrink-0">
            <svg width="51" height="49" viewBox="0 0 51 49" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="0.25" y="0.25" width="50.5" height="48.5" rx="24.25" fill="white" />
              <rect x="0.25" y="0.25" width="50.5" height="48.5" rx="24.25" stroke="#DAC8FF" strokeWidth="0.5" />
              <path
